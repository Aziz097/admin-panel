...
export function CardRilisBerita({ value = 1, target = 2, bulan = "Juni", tahun = "2024" }: {
  value?: number; target?: number; bulan?: string; tahun?: string;
}) {
  ...
  return (
    <Card className="rounded-2xl border border-zinc-200 bg-white px-6 py-6 shadow-none flex flex-col justify-between min-h-[190px] relative">
      <div>
        <div className="font-bold text-lg text-black">Release Berita</div>
      ...
      <div className="flex items-center gap-2 mt-8">
        <div className="relative w-full h-2 rounded bg-zinc-200 overflow-hidden">
          <div className="absolute h-2 left-0 top-0 bg-black rounded" style={{ width: `${percent}%` }} />
        </div>
