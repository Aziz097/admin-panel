...
const defaultData: KomunikasiData = {
  rilis: 0, foto: 0, influencer: 0, internal: "pending", scoring: 0, laporan: 0
}
...
export function SummaryKomunikasi() {
  ...
  return (
    <KomunikasiCardWrapper bulan={bulan} setBulan={setBulan}>
      ...
      <CardAkunInfluencer value={data.influencer} target={4} bulan={labelBulan} tahun="2024" />
      <CardScoringPublikasi value={data.scoring} target={2250000} bulan={labelBulan} tahun="2024" />
      <CardLaporanPublik value={data.laporan} target={1} bulan={labelBulan} tahun="2024" done={data.laporan >= 1} />
